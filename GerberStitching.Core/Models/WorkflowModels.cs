...
namespace GerberViewer.Stitching.Models
{
    ...
    public enum StitchingEngine { OpenCv, HalconProjectiveMosaic, HalconThenOpenCvFallback }
    ...
    public sealed class AlignStitchConfig { public string InputManifestPath { get; set; } public string CapturedFolderPath { get; set; } public string OutputPath { get; set; } [Browsable(false)] public SampleAlignmentMethod AlignmentMethod { get; set; } = SampleAlignmentMethod.HalconNcc; [DisplayName("Alignment Matcher")] [ReadOnly(true)] public string AlignmentMatcher { get { return "NCC_HalconMatcher"; } } public double NccMinScore { get; set; } = 0.70; public double EccMinCorrelation { get; set; } = 0.80; public double MaxTranslationPixels { get; set; } = 500.0; public double MaxAbsRotationDeg { get; set; } = 8.0; public double MinScale { get; set; } = 0.95; public double MaxScale { get; set; } = 1.05; public double MinOverlapRatio { get; set; } = 0.01; public bool AllowNccOnlyAcceptance { get; set; } public bool AllowEccFromExpectedWhenNccFails { get; set; } = true; public bool EnableNeighborRecovery { get; set; } = true; public bool EnableAnchorInterpolation { get; set; } = true; public bool AllowExpectedGridFallback { get; set; } public bool RequireManualConfirmationForExpectedGrid { get; set; } = true; public StitchingEngine StitchingEngine { get; set; } = StitchingEngine.HalconThenOpenCvFallback; public int PreviewUpdateInterval { get; set; } = 4; public double MaxPreviewMegapixels { get; set; } = 32.0; public TiffMode TiffMode { get; set; } = TiffMode.Auto; public int BigTiffTileWidth { get; set; } = 512; public int BigTiffTileHeight { get; set; } = 512; }
